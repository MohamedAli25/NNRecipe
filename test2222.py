...
from nn_recipe.NN.LossFunctions import MClassLogisticLoss
# from nn_recipe.NN.Op import GD
from nn_recipe.NN.Layers.flatten import Flatten
from nn_recipe.NN import Network
from PIL import Image
from nn_recipe.utility.one_hot_encoder import OneHotEncoder
import time
...
# print (s1*s2*n_c)
l1 = Linear(in_dim=cols, out_dim=2, activation=Sigmoid())
l1_out = l1(f_out[0])
print(l1.local_grad)

Y = np.array(["Ashraf"]).reshape(-1,1)
